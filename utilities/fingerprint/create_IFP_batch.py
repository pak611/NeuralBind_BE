...
def IFP(ligand, config):
    ...
    reference_atom = load_obj(f'{os.getcwd()}\\utilities\\fingerprint\\obj\\referAtomsList')
    reference_res = load_obj(f'{os.getcwd()}\\utilities\\fingerprint\\obj\\referResList')
    IFP_poses = []
