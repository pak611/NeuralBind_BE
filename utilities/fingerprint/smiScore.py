...
def get_parser():
    ...
    parser.add_argument("--path", help="docking results path",
                        default='C:\\Users\\patri\\Dropbox\\Ph.D\\OrganoNet\\NeuralBind\\utilities\\docking\\docked_ligands\\')
    # parser.add_argument("--save", help="dataframe name of IFP",
    #                     default='IFP')
    parser.add_argument("--dataset", help="IFP dataset path", type=str,
                        default='C:\\Users\\patri\\Dropbox\\Ph.D\\OrganoNet\\NeuralBind\\utilities\\fingerprint\\IFP_AAIFP.csv')
    parser.add_argument("--smi", help="SMILES dataset path", type=str,
                        default='C:\\Users\\patri\\Dropbox\\Ph.D\\OrganoNet\\NeuralBind\\utilities\\docking\\dataset\\test.csv')
...
#--path \\Test\\Data\\test_results  --dataset IFP_AAIFP.csv --smi \\Dataset/test.csv
